...
const categoriaProductos = React.lazy(() => import('./views/Compras/categoriaProductos/categoriaProductos.proyecto'))
...
const routes = [
  ...
  { path: '/compras/categoriaProductos', name: 'Categoria productos', element: categoriaProductos, exact: true  },
